return {
    ...
    dependencies = {
        ...
        "nvim-treesitter/nvim-treesitter", "onsails/lspkind.nvim", -- vs-code pictograms
    ...
    config = function()
        ...
        local confirm = function(entry)
            ...
            if entry then
                ...
                elseif type(completion_item.insertText) == 'string' and
                    completion_item.insertText ~= '' then
                ...
                local diff_after = math.max(0, entry.replace_range['end']
                                                .character + 1) -
        ...
        cmp.setup.cmdline(":", {
            ...
            sources = cmp.config.sources({
                ...
                {
                    name = 'buffer',
                    option = {max_item_count = 30, keyword_length = 3}
                }
            })
        })
        ...
        cmp.setup({
            ...
            sources = cmp.config.sources({
                ...
                {name = "lazydev"}, {name = "nvim_lsp"}, {name = "buffer"}, -- text within current buffer
        ...
        local toggle_ghost_text = function()
            ...
            local should_enable_ghost_text =
                character_after_cursor == '' or
