...
return {
    ...
    opts = function(_, opts)
        ...
        local snippets_file = vim.fn.expand(
                                  "~/github/obsidian_main/300-youtube/youtube-video-list.txt")
        ...
        if vim.fn.filereadable(snippets_file) == 1 then
            ...
            local function process_youtube_snippets(file_path, format_func)
                ...
                if not file then
                    vim.notify("Could not open snippets file: " .. file_path,
                    ...
                    if line == "" then
                        if #lines == 2 then
                            ...
                            local formatted_content =
                                format_func(trig_title, raw_title, url)
            ...
            local video_snippets = process_youtube_snippets(snippets_file,
                                                            format_functions.plain)
            local video_md_snippets = process_youtube_snippets(snippets_file,
                                                               format_functions.markdown)
            local video_md_snippets_ext =
                process_youtube_snippets(snippets_file,
                                         format_functions.markdown_external)
            local video_snippets_embed =
                process_youtube_snippets(snippets_file, format_functions.embed)
        ...
        local function create_code_block_typst(lang)
            return s({
                ...
                t({"#codly(header: [*"}), i(2), t({"*])", ""}),
                t({"```" .. lang, ""}), i(1), -- f(clipboard, {}),
                t({"", "```"})
            })
        end
        ...
        local languages = {
            "txt", "lua", "sql", "go", "regex", "bash", "markdown",
            "markdown_inline", "yaml", "json", "jsonc", "cpp", "csv", "java",
            "javascript", "python", "dockerfile", "html", "css", "templ", "php"
        }
        ...
        table.insert(snippets, s({
            ...
            t("[my dotfiles](https://github.com/linkarzu/dotfiles-latest)"), t({
                "", "", "```txt", "Members only discord",
                "https://www.youtube.com/channel/UCrSIvbFncPSlK6AdwE2QboA/join",
                "", "If you find this video helpful and want to support me",
                "https://ko-fi.com/linkarzu", "", "Follow me on twitter",
                "https://x.com/link_arzu", "",
                "My dotfiles (remember to star them)",
                "https://github.com/linkarzu/dotfiles-latest", "",
                "Videos mentioned in this video:", "", "#linkarzu", "",
                "1:00 - VIDEO video 1", "2:00 - VIDEO video 2", "```", "",
                "Video timeline:", "", "```txt", "0:00 -", "```", "", "```txt",
                "Join discord for free -> https://discord.gg/NgqMgwwtMH",
                "If you want to support me by becoming a YouTube member",
                "https://www.youtube.com/channel/UCrSIvbFncPSlK6AdwE2QboA/join",
                "☕ Support me -> https://ko-fi.com/linkarzu",
        ...
        table.insert(snippets, s({
            ...
            t("## "), i(1, "video name"), t({"", "", "- [ ] "}), i(2, ""), -- This is now the second jump point
            t({
                "", "- [ ] **Thank supporters**", "- [ ] Push GitHub changes",
        ...
        table.insert(snippets, s({
            ...
            t({
                "```python", "#!/usr/bin/env python3", "", "def main():",
