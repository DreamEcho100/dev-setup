    ...
    keys = {
        {
            "<leader>y",
            function()
                local picker = _G.LazyVim and _G.LazyVim.pick and _G.LazyVim.pick.picker
                if picker and picker.name == "telescope" then
                    require("telescope").extensions.yank_history.yank_history({})
                elseif picker and picker.name == "snacks" then
                    Snacks.picker.yanky()
                else
