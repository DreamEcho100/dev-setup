...
keymap.set('n', '<leader>sn', '<cmd>noautocmd w <CR>', vim.tbl_extend('force',
                                                                      opts, {
    desc = 'Save file without auto-formatting'
}))
-- Quit file
keymap.set('n', '<C-q>', '<cmd> q <CR>',
           vim.tbl_extend('force', opts, {desc = 'Quit file'}))

-- Delete
keymap.set('n', 'x', '"_x', vim.tbl_extend('force', opts, {
...
keymap.set('n', 'n', 'nzzzv',
           vim.tbl_extend('force', opts, {desc = 'Find next and center'}))
keymap.set('n', 'N', 'Nzzzv',
           vim.tbl_extend('force', opts, {desc = 'Find previous and center'}))

-- Resize with arrows
keymap.set('n', '<Up>', ':resize -2<CR>', vim.tbl_extend('force', opts, {
    desc = 'Resize window smaller (by 2)'
}))
keymap.set('n', '<Down>', ':resize +2<CR>', vim.tbl_extend('force', opts, {
    desc = 'Resize window larger (by 2)'
}))
keymap.set('n', '<Left>', ':vertical resize -2<CR>', vim.tbl_extend('force',
                                                                    opts, {
    desc = 'Resize window narrower (by 2)'
}))
keymap.set('n', '<Right>', ':vertical resize +2<CR>',
           vim.tbl_extend('force', opts, {desc = 'Resize window wider (by 2)'}))
...
keymap.set('n', '<leader>se', '<C-w>=', vim.tbl_extend('force', opts, {
    desc = 'Make split windows equal width & height'
}))
keymap.set('n', '<leader>xs', ':close<CR>',
           vim.tbl_extend('force', opts, {desc = 'Close current split window'}))

-- Navigate between splits
keymap.set('n', '<C-k>', ':wincmd k<CR>',
           vim.tbl_extend('force', opts, {desc = 'Move to upper split window'}))
keymap.set('n', '<C-j>', ':wincmd j<CR>',
           vim.tbl_extend('force', opts, {desc = 'Move to lower split window'}))
keymap.set('n', '<C-h>', ':wincmd h<CR>',
           vim.tbl_extend('force', opts, {desc = 'Move to left split window'}))
keymap.set('n', '<C-l>', ':wincmd l<CR>',
           vim.tbl_extend('force', opts, {desc = 'Move to right split window'}))
...
keymap.set('n', '<leader>tn', ':tabn<CR>',
           vim.tbl_extend('force', opts, {desc = 'Go to next tab'}))
keymap.set('n', '<leader>tp', ':tabp<CR>',
           vim.tbl_extend('force', opts, {desc = 'Go to previous tab'}))
keymap.set('n', '<leader>tf', ':tabnew %<CR>', vim.tbl_extend('force', opts, {
...
keymap.set('v', '<', '<gv', vim.tbl_extend('force', opts, {
    desc = 'Indent line and stay in indent mode'
}))
keymap.set('v', '>', '>gv', vim.tbl_extend('force', opts, {
    desc = 'Unindent line and stay in indent mode'
}))

-- Keep last yanked when pasting
keymap.set('v', 'p', '"_dP', vim.tbl_extend('force', opts, {
